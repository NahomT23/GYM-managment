...
const SignIn = () => {
  ...
  // Initialize the form hook with zod validation schema
  const form = useForm({
    resolver: zodResolver(signInFormSchema),
    defaultValues: {
      email: "",
  ...
  return (
    <div>
      <Card className="w-full max-w-2xl mx-auto">
        ...
        <CardContent>
          <UiForm children={undefined} {...form} /> {/* Pass the form hook here */}
          <SignInForm onSubmit={onSubmit} /> {/* Pass onSubmit to the SignInForm */}
        </CardContent>
